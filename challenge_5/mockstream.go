//////////////////////////////////////////////////////////////////////
//
// Note: I obtained this from https://github.com/loong/go-concurrency-exercises
//
...
// Stream is a mock stream for demonstration purposes, not thread-safe
type Stream struct {
	pos    int
	tweets []Tweet
}
...
var mockData = []Tweet{
	{
		...
		"ken_thompson",
		"Looking forward to the #gopher meetup in San Francisco tonight with @rob_pike!",
	}, {
		"dijkstra_020",
